...
!!
!! SVN              :
!! $HeadURL: svn://forge.ipsl.fr/orchidee/trunk/ORCHIDEE/src_parallel/mod_orchidee_transfert_para.F90 $
!! $Date: 2019-09-10 16:19:45 +0200 (mar. 10 sept. 2019) $
!! $Revision: 6190 $
!! \n
!_ ================================================================================================================================
...
!_ ================================================================================================================================
  ...
  INTERFACE scatter_unindexed
    MODULE PROCEDURE scatter_unindexed_i,scatter_unindexed_i1,scatter_unindexed_i2,scatter_unindexed_i3, scatter_unindexed_i4, &
                     scatter_unindexed_r,scatter_unindexed_r1,scatter_unindexed_r2,scatter_unindexed_r3, scatter_unindexed_r4, &
                     scatter_unindexed_l,scatter_unindexed_l1,scatter_unindexed_l2,scatter_unindexed_l3, scatter_unindexed_l4
  END INTERFACE

  
  INTERFACE gather_unindexed
    MODULE PROCEDURE gather_unindexed_i,gather_unindexed_i1,gather_unindexed_i2,gather_unindexed_i3, gather_unindexed_i4, &
                     gather_unindexed_r,gather_unindexed_r1,gather_unindexed_r2,gather_unindexed_r3, gather_unindexed_r4, &
                     gather_unindexed_l,gather_unindexed_l1,gather_unindexed_l2,gather_unindexed_l3, gather_unindexed_l4  
  END INTERFACE
...
!_ ================================================================================================================================
  INTERFACE allreduce_sum
    MODULE PROCEDURE allreduce_sum_r, allreduce_sum_i
  END INTERFACE 
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 ...
 SUBROUTINE scatter_unindexed_i(VarIn, VarOut)
  ...
  SUBROUTINE scatter_unindexed_i4(VarIn, VarOut)
  IMPLICIT NONE
  
    INTEGER,INTENT(IN),DIMENSION(:,:,:,:,:) :: VarIn
    INTEGER,INTENT(OUT),DIMENSION(:,:,:,:,:) :: VarOut

    INTEGER,DIMENSION(ij_nb,SIZE(Varout,2),SIZE(Varout,3),SIZE(Varout,4), SIZE(Varout,5)) :: Var_tmp

    
    IF (is_omp_root) CALL scatter_unindexed_mpi(VarIn,Var_tmp)
    CALL scatter_unindexed_omp(Var_tmp,VarOut)
    
  END SUBROUTINE scatter_unindexed_i4
  ...
  SUBROUTINE scatter_unindexed_r4(VarIn, VarOut)
  IMPLICIT NONE
  
    REAL,INTENT(IN),DIMENSION(:,:,:,:,:) :: VarIn
    REAL,INTENT(OUT),DIMENSION(:,:,:,:,:) :: VarOut

    REAL,DIMENSION(ij_nb,SIZE(Varout,2),SIZE(Varout,3),SIZE(Varout,4),SIZE(Varout,5)) :: Var_tmp

    
    IF (is_omp_root) CALL scatter_unindexed_mpi(VarIn,Var_tmp)
    CALL scatter_unindexed_omp(Var_tmp,VarOut)
    
  END SUBROUTINE scatter_unindexed_r4
  ...
  SUBROUTINE scatter_unindexed_l4(VarIn, VarOut)
  IMPLICIT NONE
  
    LOGICAL,INTENT(IN),DIMENSION(:,:,:,:,:) :: VarIn
    LOGICAL,INTENT(OUT),DIMENSION(:,:,:,:,:) :: VarOut

    LOGICAL,DIMENSION(ij_nb,SIZE(Varout,2),SIZE(Varout,3),SIZE(Varout,4),SIZE(Varout,5)) :: Var_tmp

    
    IF (is_omp_root) CALL scatter_unindexed_mpi(VarIn,Var_tmp)
    CALL scatter_unindexed_omp(Var_tmp,VarOut)
    
  END SUBROUTINE scatter_unindexed_l4
...
!!!!! --> Les entiers
  ...
  SUBROUTINE gather_unindexed_i4(VarIn, VarOut)
  IMPLICIT NONE
  
    INTEGER,INTENT(IN),DIMENSION(:,:,:,:,:) :: VarIn
    INTEGER,INTENT(OUT),DIMENSION(:,:,:,:,:) :: VarOut
    
    INTEGER, DIMENSION(ij_nb,SIZE(VarIn,2),SIZE(VarIn,3),SIZE(VarIn,4),SIZE(VarIn,5)) :: Var_tmp
  ...
  END SUBROUTINE gather_unindexed_i4
...
!!!!! --> Les reels
  ...
  SUBROUTINE gather_unindexed_r4(VarIn, VarOut)
  IMPLICIT NONE
  
    REAL,INTENT(IN),DIMENSION(:,:,:,:,:) :: VarIn
    REAL,INTENT(OUT),DIMENSION(:,:,:,:,:) :: VarOut
    
    REAL, DIMENSION(ij_nb,SIZE(VarIn,2),SIZE(VarIn,3),SIZE(VarIn,4),SIZE(VarIn,5)) :: Var_tmp
    
    CALL gather_unindexed_omp(VarIn,Var_tmp)
    
    IF (is_omp_root) CALL gather_unindexed_mpi(Var_tmp,VarOut)
  
  END SUBROUTINE gather_unindexed_r4
...
!!!!! --> Les booleens
  ...
  SUBROUTINE gather_unindexed_l4(VarIn, VarOut)
  IMPLICIT NONE
  
    LOGICAL,INTENT(IN),DIMENSION(:,:,:,:,:) :: VarIn
    LOGICAL,INTENT(OUT),DIMENSION(:,:,:,:,:) :: VarOut
    
    LOGICAL, DIMENSION(ij_nb,SIZE(VarIn,2),SIZE(VarIn,3),SIZE(VarIn,4),SIZE(VarIn,5)) :: Var_tmp
    
    CALL gather_unindexed_omp(VarIn,Var_tmp)
    
    IF (is_omp_root) CALL gather_unindexed_mpi(Var_tmp,VarOut)
  
  END SUBROUTINE gather_unindexed_l4
...
! AllReduce sum subroutines for integers

  SUBROUTINE allreduce_sum_i(VarIn, VarOut)
  IMPLICIT NONE
  ...
  END SUBROUTINE allreduce_sum_i
