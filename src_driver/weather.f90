...
!!
!! SVN          :
!! $HeadURL: svn://forge.ipsl.fr/orchidee/trunk/ORCHIDEE/src_driver/weather.f90 $
!! $Date: 2025-01-27 11:55:22 +0100 (lun. 27 janv. 2025) $
!! $Revision: 8792 $
!! \n
!_ ================================================================================================================================
...
!-----
      ...
      CALL allreduce_sum(count_not_ok,count_not_ok_g)
!-
      z(:) = zero
