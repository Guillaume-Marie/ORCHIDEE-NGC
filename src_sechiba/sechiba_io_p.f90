...
!!
!! SVN          :
!! $HeadURL: svn://forge.ipsl.fr/orchidee/trunk/ORCHIDEE/src_sechiba/sechiba_io_p.f90 $
...
MODULE sechiba_io_p
  ...
  INTERFACE setvar_p
    ...
    MODULE PROCEDURE r0setvar_p, r10setvar_p, r20setvar_p, r11setvar_p, r21setvar_p, &
         r22setvar_p, r30setvar_p, r40setvar_p, r50setvar_p  
  END INTERFACE
...
!! =============================================================================================================================
!! SUBROUTINE   : r40setvar_p
!!
!>\BRIEF	  Subroutine for initializing an real 4D variable with a scalar real variable.
!!
!! DESCRIPTION  : Subroutine for initializing an real 4D variable with a scalar real variable.
!!                This subroutine must be called by all processes.
!! \n
!_ =============================================================================================================================

SUBROUTINE r40setvar_p (var, val_exp, key_wd, val_put)

  REAL(r_std), DIMENSION(:,:,:,:), INTENT(inout) :: var                !! 4D integer array to modify
  REAL(r_std), INTENT(in)                      :: val_exp              !! Exceptional value
  CHARACTER(LEN=*), INTENT(in)                 :: key_wd               !! The Key word we will look for
  REAL(r_std), INTENT(in)                      :: val_put              !! Scalar value to stored
  ...
  IF (long_print_setvar_p) WRITE(numout,*) 'r40setvar',val_exp, val_put
...
END SUBROUTINE r40setvar_p

!! =============================================================================================================================
!! SUBROUTINE   : r50setvar_p
!!
!>\BRIEF	  Subroutine for initializing an real 5D variable with a scalar real variable.
!!
!! DESCRIPTION  : Subroutine for initializing an real 5D variable with a scalar real variable.
!!                This subroutine must be called by all processes.
!! \n
!_ =============================================================================================================================

SUBROUTINE r50setvar_p (var, val_exp, key_wd, val_put)

  REAL(r_std), DIMENSION(:,:,:,:,:), INTENT(inout) :: var              !! 5D integer array to modify
  REAL(r_std), INTENT(in)                      :: val_exp              !! Exceptional value
  CHARACTER(LEN=*), INTENT(in)                 :: key_wd               !! The Key word we will look for
  REAL(r_std), INTENT(in)                      :: val_put              !! Scalar value to stored
  ...
  IF (long_print_setvar_p) WRITE(numout,*) 'r50setvar',val_exp, val_put
